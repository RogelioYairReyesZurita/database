...
/////////////////////////////////eliminar dato/////////////////////////////////////////////////////////
    ...
    const signIn = async (req=request, res=response)=>{
        ...
        if(!username||!password){
            res.status(400).json({msg:'User and password are required'});
            return;
        }
...
module.exports={listUsers, listUsersByID, addUser,ModUser,Deleteuser,signIn};